...
function home() {
  return `<section class="hero hero-immersive" aria-labelledby="hero-title"><div class="hero-meta"><span>Yuchao Qin / Research portfolio</span><span>Singapore · NUS</span></div><h1 id="hero-title" class="hero-title"><span>YUCHAO</span> <span class="surname">QIN<span class="name-period">.</span></span></h1><div class="visual"><canvas id="research-graph" role="img" aria-label="Rotating three-dimensional toroidal mathematical surface, traced by flowing particles"></canvas></div><div class="hero-intro"><p>Exploring the architecture<br>of intelligent computing.</p><a class="hero-cv" href="./assets/yuchaoCV.pdf" target="_blank" rel="noopener">Curriculum vitae <span aria-hidden="true">↗</span></a></div><div class="hero-affiliation"><span>Ph.D. student, Computer Science</span><strong>National University of Singapore</strong><span>Advised by Prof. Tulika Mitra</span></div><div class="hero-bottom"><a href="#research" class="scroll-cue" data-scroll="research"><span class="scroll-circle" aria-hidden="true">↓</span> Scroll to explore</a><span class="visual-label">FORM 001 — TOROIDAL FIELD</span><button class="motion-button" id="motion-toggle" aria-label="Pause animation">Pause motion Ⅱ</button></div></section>
